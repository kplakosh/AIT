...
const isConfigured = (formId: string) => Boolean(formId && formId !== 'your_form_id_here')
    ...
    return (
      <Card variant="elevated" className="h-full">
        ...
        <p className="rounded-lg border border-warm-gold/30 bg-warm-gold/10 px-4 py-3 text-sm text-navy-plum/85">
          ...
          <code className="rounded bg-white/60 px-1 py-0.5 text-xs">PUBLIC_FORMSPREE_FORM_ID</code>{' '}
